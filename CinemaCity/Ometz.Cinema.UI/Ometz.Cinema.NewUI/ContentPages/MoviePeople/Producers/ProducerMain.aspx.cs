...
{
    public partial class ProducerMain : System.Web.UI.Page
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            if (IsPostBack)
            {
                if (MainMoviePeople1.GridMovieList.SelectedIndex > -1)
                {
                    ...
                    string url = "ProducersInMovie.aspx?movieId=" + movieId + "&movieTitle=" + movieTitle + "&selector=producersInMovie";
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            string url = "ProducersInMovie.aspx?personToShow=" + personToShow + "&selector=producerFoundByName";
            Response.Redirect(url);               
